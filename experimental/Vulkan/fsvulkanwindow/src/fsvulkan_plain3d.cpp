...
FsVulkanContext::Plain3dRenderer *FsVulkanContext::RendererPool::CreatePlain3dRenderer(VkRenderPass renderPass)
{
printf("%s %d\n",__FUNCTION__,__LINE__);
	Plain3dRenderer *renderer;
	renderer=new Plain3dRenderer(this);
	...
	uniformBinding[0].stageFlags=VK_SHADER_STAGE_VERTEX_BIT;
	long long int length=sizeof(float)*16;
...
////////////////////////////////////////////////////////////
	...
	auto vertShaderModule=owner->CreateShaderModule(plain3d_vert_spv_len,plain3d_vert_spv,"plain3d_vert_spv");
	auto fragShaderModule=owner->CreateShaderModule(plain3d_frag_spv_len,plain3d_frag_spv,"plain3d_frag_spv");
