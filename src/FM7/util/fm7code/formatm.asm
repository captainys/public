					...
					EXPORT		FORMAT_PREGAP_LENGTH
					EXPORT		FORMAT_SYNC_LENGTH
					EXPORT		FORMAT_GAP2_LENGTH
					EXPORT		FORMAT_GAP3_LENGTH
...
FORMAT_PREGAP_LENGTH	FDB		32
FORMAT_SYNC_LENGTH		FDB		12
FORMAT_GAP2_LENGTH		FDB		$16		; Not 16 bytes.  It's #$16 bytes.
FORMAT_GAP3_LENGTH		FDB		$36		; Not 36 bytes.  It's #$36 bytes.

MAKETRACKIMAGE		LDX		TRACKINFOPTR,PCR
					LDY		TRACKIMAGEPTR,PCR
					LDA		#$4E
					LDU		FORMAT_PREGAP_LENGTH,PCR
					BSR		FILL
...
SECTORLOOP			CLRA	; SYNC
					LDU		FORMAT_SYNC_LENGTH,PCR
					BSR		FILL
