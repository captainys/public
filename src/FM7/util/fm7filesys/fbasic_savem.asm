...
FSYS_FILE_SAVEM_FILENAME_CLEAR_LOOP
						...
						STB		8,S			; Bytes into the sector

						LDX		FSYS_FILE_SAVEM_FILE_INFO,S
						LDD		2,X			; Location of the data
						STD		12,S		; Data pointer for WRITE_TO_CLUSTER_CHAIN
						LDD		6,X
						STD		10,S		; Size left for WRITE_TO_CLUSTER_CHAIN
						LEAX	3,S
						LDY		FSYS_FILE_SAVEM_FAT_BUFFER,S
						...
						LEAX	15,S
						STX		12,S		; Data pointer for WRITE_TO_CLUSTER_CHAIN
						LDD		#5
						STD		10,S		; Size left for WRITE_TO_CLUSTER_CHAIN
