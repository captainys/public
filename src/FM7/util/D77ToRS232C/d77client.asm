...
CHECKSUM_ERROR_MSG	FCB		"CHECKSUM_ERROR.  RE-TRYING.",$0D,$0A,0
XOR_ERROR_MSG		FCB		"XOR_ERROR.  RE-TRYING.",$0D,$0A,0
ADDRESS_ERROR_MSG	FCB		"ADDRESS_ERROR.  RE-TRYING.",$0D,$0A,0
NOTREADY_ERROR_MSG	FCB		"DRIVE NOT READY.",$0D,$0A,0
