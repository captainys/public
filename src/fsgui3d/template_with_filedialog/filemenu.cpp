...
void FsGui3DMainCanvas::RefreshRecentlyUsedFileList(void)
{
	...
	if(nullptr!=fp)
	{
		...
		recent.PopulateMenu(*fileRecent,16,&FsGui3DMainCanvas::File_Recent,this);
	}
}

void FsGui3DMainCanvas::AddRecentlyUsedFile(YsWString fName)
{
...
YsWString FsGui3DMainCanvas::GetRecentFileListFileName(void) const
{
